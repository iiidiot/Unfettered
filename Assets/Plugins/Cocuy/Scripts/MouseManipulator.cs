...
public class MouseManipulator : MonoBehaviour {
    ...
    public float noInputParticleStrength = 5f;
    public float inputParticleStrength = 10f;
    ...
    void LateUpdate()
	{
        ...
        {
            m_particlesStrength = noInputParticleStrength;
        }
        else
        {
            m_particlesStrength = inputParticleStrength;
        }
